...
//       // סינון רק טפסים מהפקולטה שלי שאושרו על ידי ראש מחלקה
//       const pendingForms = formsForReview.filter(instance => 
//         instance.currentStage === 'ApprovedByDepartment' && 
//         instance.facultyID === user.facultyID // צריך להוסיף שדה זה לAPIֲ
//       );

//       // חישוב סטטיסטיקות
//       const stats = {
//         pendingReview: pendingForms.length,
//         departments: [...new Set(formsForReview.filter(f => f.facultyID === user.facultyID).map(f => f.userDepartmentID))].length,
...
//     const statusMap = {
//       'ApprovedByDepartment': { variant: 'info', text: 'מראש מחלקה', icon: 'bi-check-circle' },
//       'ApprovedByDean': { variant: 'success', text: 'אושר על ידי', icon: 'bi-check-circle-fill' },
...
//                   <p className="mb-0 opacity-75">דיקאן - לוח בקרה פקולטה</p>
//                 </Col>
//                 <Col xs="auto">
...
//             <Card.Body className="text-center">
//               <i className="bi bi-building text-info" style={{ fontSize: '2.5rem' }}></i>
//               <h3 className="mt-2 mb-1 text-info">{dashboardData.stats.departments}</h3>
//               <small className="text-muted">מחלקות</small>
//             </Card.Body>
//           </Card>
//         </Col>
//         <Col md={3} className="mb-3">
//           <Card className="card-hover h-100 border-primary">
//             <Card.Body className="text-center">
//               <i className="bi bi-calendar-month text-primary" style={{ fontSize: '2.5rem' }}></i>
//               <h3 className="mt-2 mb-1 text-primary">{dashboardData.stats.thisMonth}</h3>
...
//                 טפסים לבדיקה מראשי מחלקות
//               </h5>
//               <Button as={Link} to="/dean/review" variant="outline-primary" size="sm">
//                 צפה בכולם
//               </Button>
//             </Card.Header>
//             <Card.Body>
...
//                   <small>כל הטפסים בפקולטה נבדקו</small>
//                 </div>
//               ) : (
...
//                           </td>
//                           <td>
//                             <Badge bg="light" text="dark">{instance.userDepartmentID}</Badge>
//                           </td>
//                           <td>
//                             <div>
...
//                             <Button
//                               as={Link}
//                               to={`/dean/review#instance-${instance.instanceId}`}
...
//                   <span>פקולטה:</span>
//                   <span>{user?.facultyID || 'לא זמין'}</span>
//                 </div>
//                 <div className="d-flex justify-content-between mb-2">
//                   <span>תפקיד:</span>
