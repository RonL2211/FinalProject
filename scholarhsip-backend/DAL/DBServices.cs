...
namespace FinalProject.DAL
{
    public class DBServices
    {
        ...
        //public SqlDataReader  ExecuteQuery(string spName, Dictionary<string, object> paramDic)
        //{
        //    SqlConnection con = null;
        //    try
        //    {
        //        con = Connect("myProjDB");
        //        SqlCommand cmd = CreateCommandWithStoredProcedure(spName, con, paramDic);
        //        SqlDataReader reader = cmd. ExecuteQuery(CommandBehavior.CloseConnection);
        //        return reader;
        //    }
        //    catch (Exception ex)
        //    {
